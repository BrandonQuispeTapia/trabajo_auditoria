...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{imagenes/diagramas/flujo_proceso.jpg}
  ...
  \textcite{sec2011ni43101}. La etapa 7 (destrucción de cianuro) es la barrera
  de contención del riesgo químico del circuito; la certificación bajo el
  International Cyanide Management Code cubre el cianuro, no el drenaje ácido
  de roca, que tiene origen geoquímico distinto y exige controles propios.
\end{figure}
