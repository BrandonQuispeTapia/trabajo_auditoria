...
\begin{longtable}{@{}L{1.7cm} L{4.2cm} L{4.6cm} L{2.9cm} L{1.6cm} L{4.4cm} L{3.2cm}@{}}
  ...
  \textcite{cidh2010medidas}, \textcite{basu2010metales} y
  \textcite{copaesfmonitoreo}. La clasificación es una adaptación propia
  ...
  \parencite{basu2010metales} y en aguas abajo del reservorio
  \parencite{copaesfmonitoreo}, frente a monitoreos que sostienen conformidad &
  --- &
  \OBS &
...
planificación del cierre \parencite{oncommonground2010hria}. Existe además un
riesgo geoquímico documentado de drenaje ácido de roca, derivado de la
mineralogía piritosa descrita en la sección \ref{sec:unidad}
...
Del lado de la afectación, el estudio coordinado por Physicians for Human Rights
con participación de la Universidad de Michigan halló que una muestra de
residentes próximos a la mina presentaba niveles más altos de mercurio, cobre,
arsénico y zinc en orina, y de plomo en sangre, que una muestra de personas
residentes a siete kilómetros de distancia \parencite{basu2010metales}. El
monitoreo de la Comisión Pastoral Paz y Ecología reportó arsénico, cobre, aluminio
y manganeso por encima de estándares en puntos situados aguas abajo del reservorio
de relaves \parencite{copaesfmonitoreo}.

Ahora bien, el propio estudio de salud incorporó una advertencia que sería
tendencioso omitir: sus autores señalaron que no resultaba claro si la magnitud de
esas elevaciones representaba una amenaza significativa para la salud. Citar la
primera mitad del hallazgo sin la segunda constituiría una manipulación de la
fuente, y este informe no la comete.
