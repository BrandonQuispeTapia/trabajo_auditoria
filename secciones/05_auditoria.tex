...
% --- FIGURA 3: Cronología del proceso de auditoría -------------------
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{imagenes/diagramas/linea_tiempo_auditoria.jpg}
  \caption{Cronología del proceso de auditoría de la Mina Marlin (2004--2011)}
  \label{fig:metodologia}
  \par\vspace{2pt}
  \raggedright\footnotesize
  Nota. Elaboración propia a partir de \textcite{oncommonground2010hria},
  \textcite{cao2006marlin} y \textcite{cidh2010medidas}. El cierre de la mina
  (31 de mayo de 2017) queda fuera del tramo representado; se detalla en la
  cronología completa del Anexo \ref{anexo:cronologia}.
\end{figure}
